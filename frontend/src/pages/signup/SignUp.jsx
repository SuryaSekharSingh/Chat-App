      ...
      <div className='w-full max-w-md p-6 rounded-lg shadow-lg bg-white/10 backdrop-blur-md border border-white/20 bg-opacity-30 text-gray-300'>
        ...
        <form>
          <div>
            ...
            <input type="text" placeholder='Kalu Singh' className='w-full input input-bordered h-10' />
          </div>
          ...
          <div>
            ...
            <input type="text" placeholder='kalusingh' className='w-full input input-bordered h-10' />
          </div>
